...
bool robot_interfaces__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // simulated
    PyObject * field = PyObject_GetAttrString(_pymsg, "simulated");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->simulated = (Py_True == field);
    Py_DECREF(field);
  }
  {  // state_valid
    PyObject * field = PyObject_GetAttrString(_pymsg, "state_valid");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->state_valid = (Py_True == field);
    Py_DECREF(field);
  }
  {  // flange_pose
  ...
  {  // gripper_opening_m
    PyObject * field = PyObject_GetAttrString(_pymsg, "gripper_opening_m");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->gripper_opening_m = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // gripper_force_n
    PyObject * field = PyObject_GetAttrString(_pymsg, "gripper_force_n");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->gripper_force_n = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // controller_state
    ...
    ros_message->controller_state = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // active_command_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "active_command_id");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->active_command_id, PyBytes_AS_STRING(encoded_field));
...
PyObject * robot_interfaces__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // simulated
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->simulated ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "simulated", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // state_valid
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->state_valid ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "state_valid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // gripper_opening_m
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->gripper_opening_m);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gripper_opening_m", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // gripper_force_n
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->gripper_force_n);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gripper_force_n", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // controller_state
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->controller_state);
    {
  ...
  {  // active_command_id
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->active_command_id.data,
      strlen(ros_message->active_command_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "active_command_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
